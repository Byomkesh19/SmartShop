...
/**
 * Servlet implementation class FootwearBillingDisplayServlet
 */
@WebServlet("/FootwearBillingDisplayServlet")
public class FootwearBillingDisplayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final static Logger LOGGER = MyLogger.getlogger(FootwearBillingDisplayServlet.class.getName());  

       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FootwearBillingDisplayServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd=request.getRequestDispatcher("footwear_b.jsp");
