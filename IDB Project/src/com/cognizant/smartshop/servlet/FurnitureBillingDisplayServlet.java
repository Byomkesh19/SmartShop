...
/**
 * Servlet implementation class FurnitureBillingDisplayServlet
 */
@WebServlet("/FurnitureBillingDisplayServlet")
public class FurnitureBillingDisplayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final static Logger LOGGER = MyLogger.getlogger(FurnitureBillingDisplayServlet.class.getName());  

       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FurnitureBillingDisplayServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd=request.getRequestDispatcher("furniture_b.jsp");
