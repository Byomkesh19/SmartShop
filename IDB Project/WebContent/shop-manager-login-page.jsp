...
<form class="log" action="LoginShopManagerServlet" method="post" onsubmit='return loginValidate()'>

<p>Shop Manager Login</p>
<br><br>
<c:if test="${loginMes==false}"><h2>Wrong Credentials</h2></c:if>
<c:if test="${flag==true}">Your user Id is: ${userId}</c:if>
<br>
Enter User Id:<br>
