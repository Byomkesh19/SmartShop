...
<a href="homepage_customer.jsp">QuickStore</a>
<a class="logout" href="CustomerLogoutServlet">Logout</a>
</header>
...
<div class="row">
  <div class="column electronics">
    <div class="content">
      ...
      <h4><a href="ShowAllProductToCustomerServlet?productType=${1}">Electronics</a></h4>
  ...
  <div class="column home">
    ...
    <img src="images/homeapp.jpg" alt="furniture" style="width:100%">
      <h4><a href="ShowAllProductToCustomerServlet?productType=${2}">Furniture</a></h4>
  ...
  <div class="column fashion">
    ...
    <img src="images/fashion.jpg" alt="fashion" style="width:100%">
      <h4><a href="ShowAllProductToCustomerServlet?productType=${3}">Fashion</a></h4>
      <p></p>
    </div>
  </div>
  </div>
  ...
  <div class="column footwear">
    <div class="content">
      ...
      <h4><a href="ShowAllProductToCustomerServlet?productType=${4}">Footwear</a></h4>
  ...
  <div class="column beauty">
    ...
    <img src="images/makeup.jpg" alt="Car" style="width:100%">
      <h4><a href="ShowAllProductToCustomerServlet?productType=${5}">Beauty</a></h4>
