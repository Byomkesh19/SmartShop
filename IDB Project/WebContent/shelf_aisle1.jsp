...
<div class="row">
  <div class="column electronics">
    <div class="content">
      ...
      <h4><a href="electronics3_s.jsp?variablename=${'producttype'}">Electronics</a></h4>
  ...
  <div class="column home">
    ...
    <img src="images/homeapp.jpg" alt="Lights" style="width:100%">
      <h4><a href="furniture3_s.jsp">Furniture</a></h4>
  ...
  <div class="column fashion">
    ...
    <img src="images/fashion.jpg" alt="Nature" style="width:100%">
      <h4><a href="fashion3_s.jsp">Fashion</a></h4>
      <p></p>
    </div>
  </div>
  </div>
  ...
  <div class="column footwear">
    <div class="content">
      ...
      <h4><a href="footwear3_s.jsp">Footwear</a></h4>
  ...
  <div class="column beauty">
    ...
    <img src="images/makeup.jpg" alt="Car" style="width:100%">
      <h4><a href="beauty3_s.jsp">Beauty</a></h4>
